...
Paste a company URL and see how AI search engines describe your brand. HyperRank fetches the homepage, derives the company's category and competitors, runs buyer-intent prompts through public AI search surfaces, and returns a brutalist visibility scorecard.

Built with [Hyperbrowser](https://hyperbrowser.ai).

## How it works

1. **Fetch** the company homepage with Hyperbrowser's stealth `fetch` API.
...
- `@hyperbrowser/sdk` — stealth fetch for both the company homepage and AI search results
...
- Google AI Overview is region/account-gated; if the fetch fails the Google card reports it cleanly.
